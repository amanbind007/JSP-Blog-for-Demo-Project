...
List<Post> posts = pd.getPostbyUserID(id);
%>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
  <div class="container">
    <a class="navbar-brand" href="home.jsp">My Posts | Discussion BLOG</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="MyPosts.jsp?Id=<%=user.userID%>">My Posts</a>
        </li>
        <li class="nav-item">
